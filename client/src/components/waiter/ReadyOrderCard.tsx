      ...
      <div className="bg-gradient-to-r from-green-50 to-green-100 border-b border-green-200 p-3 sm:p-4">
        <div className="flex items-center justify-between mb-2 sm:mb-3">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-full p-2 sm:p-3">
            ...
            {order.orderItems?.map((item) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <span className="font-bold text-charcoal bg-green-100 rounded px-1.5 sm:px-2 py-0.5 text-xs border border-green-300">
                    {item.quantity}x
                  </span>
