            ...
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-b border-blue-200 p-4">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2">
                        <span className="px-3 py-1 bg-blue-200 text-blue-800 rounded-lg text-xs font-semibold border border-blue-300">
                            PENDING
                        </span>
                        <button
                        ...
                        >
                            <ChevronDown className={`w-5 h-5 text-charcoal transition-transform duration-300 ${isExpanded ? 'rotate-180' : ''}`} />
                        </button>
                    </div>
                </div>
