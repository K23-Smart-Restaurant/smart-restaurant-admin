      ...
      <div className="relative bg-white rounded-xl shadow-2xl max-w-lg w-full mx-4 overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="bg-amber-50 px-6 py-4 border-b border-amber-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Active Orders Warning</h3>
              <p className="text-sm text-amber-600 font-medium">Table {tableNumber}</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="px-6 py-5">
          <div className="flex items-center gap-2 text-amber-700 mb-4">
            ...
            <span className="font-medium">
              {activeOrdersCount} active order{activeOrdersCount > 1 ? 's' : ''} found
            </span>
          </div>

          <p className="text-gray-600 leading-relaxed mb-4">
            This table has unpaid orders. Deactivating will prevent new orders from being placed but
            will not affect existing orders.
          </p>
          ...
          <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-sm text-amber-800 flex items-start gap-2">
              ...
              <span>
                Are you sure you want to deactivate this table? Consider completing or canceling
                active orders first.
              </span>
            </p>
          </div>
