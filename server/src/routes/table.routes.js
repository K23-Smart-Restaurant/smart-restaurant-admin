...
import { createTableSchema, updateTableSchema } from '../schemas/table.schema.js';

const router = Router();
const tableController = new TableController();

// Public route for QR code validation (used by customer app)
router.get('/validate-qr', (req, res, next) => tableController.validateQRToken(req, res, next));
...
router.post('/batch/download', (req, res, next) => tableController.downloadBatchQR(req, res, next));
...
router.post('/:id/regenerate-qr', (req, res, next) => tableController.regenerateQR(req, res, next));
router.get('/:id/qr-code', (req, res, next) => tableController.downloadQR(req, res, next));
...
router.delete('/:id', (req, res, next) => tableController.delete(req, res, next));
